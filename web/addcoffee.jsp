          ...
          <!-- Content Row -->
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Add Coffee</h6>
                </div>
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="img/undraw_posting_photo.svg" alt="">
                  </div>
                    <form class="user" action="CoffeeController?data=coffee&proses=input-coffee" method="post">
                <div class="form-group">
                     <label for="uname"><b>Coffee Name</b></label>
                    <input type="text" class="form-control" id="exampleFirstName" name="coffee_name" placeholder="Coffee Name" required>
                </div>
                <div class="form-group">
                     <label for="st"><b>Stock</b></label>
                    <input type="text" class="form-control" id="exampleFirstName" name="stock" placeholder="Stock" required>
                </div>
                <div class="form-group">
                     <label for="pric"><b>Price</b></label>
                    <input type="text" class="form-control" id="exampleFirstName" name="price" placeholder="Price" required>
                </div>
